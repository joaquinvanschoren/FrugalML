...
public class FlexibleActions extends FrameLayout {
    ...
    /**
     * Sets a content view that will be displayed inside this FloatingActionButtonFlexibleActions.
     * @param contentView
     */
    ...
    public View getActivityContentView() {
        try {
            ...
            throw new ClassCastException("Please provide an Activity context for this FloatingActionButtonFlexibleActions.");
        }
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            // Default FloatingActionButtonFlexibleActions settings
